...
Using OOP logic, a second game - **Higher or Lower** has been created also. To play, make sure you are in `HigherLowerGameMain.java` before running the application.
